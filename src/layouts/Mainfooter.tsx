...
import PDFModal from '../layouts/PDFModal';
            ...
            <section className="w-full main-container flex flex-col items-start justify-start gap-6 p-5 !text-white">
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="w-full flex flex-col items-start justify-start gap-4">
                        ...
                        <p className="text-white capitalize cursor-pointer" onClick={handleTerms}>
                            terms & conditions
                        </p>
                    </div>
                    <div className="w-full flex flex-col items-start justify-start gap-4">
                ...
                <div className="w-full h-12 center">
                    <p className="text-white font-bold capitalize">
                        All &#169; copyrights are reserved by Edsomfintech {new Date().getFullYear()}
                    </p>
                </div>
            </section>
